/**
 * Quelle: https://gist.github.com/jewelsea/3388637
 */

package com.pimpelkram.universalfilefinder.utils;
	...
	public static void fadeOnClick(final Node node, final EventHandler<ActionEvent> onFinished) {
		node.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent mouseEvent) {
				...
				final FadeTransition fade = new FadeTransition(Duration.seconds(1.2), node);
